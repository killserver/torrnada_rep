...
$temp_date = time() - (3600 * $hours);
$temp_date = get_date_time($temp_date);
...
$query = sql_query("SELECT id, name, (SELECT name FROM categories WHERE id = category) as cat_name FROM torrents WHERE added >= \"".$temp_date."\" AND category = ".$cat['id']." ORDER BY category ASC") or sqlerr(__FILE__,__LINE__);
...
//$view_cat_video[] = $temp_date."<br /><br /><br /><br />";
