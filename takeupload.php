...
$ret = sql_query("INSERT INTO torrents (search_text, filename, owner, visible, sticky, info_hash, multi_infohash, name, size, numfiles, type, descr, ori_descr, youtube, multitracker, free, image1, image2, image3, image4, image5, image6, category, save_as, added, last_action, kp, relizgroup, status, modby) VALUES (" . implode(",", array_map("sqlesc", array(searchfield("$shortfname $dname $torrent"), $filename, $CURUSER["id"], $visible, $sticky, $infohash, $multi_infohash, $torrent, $totallen, count($filelist), $type, $descr, $descr, $youtube, $multut, $free, $inames[0], $inames[1], $inames[2], $inames[3], $inames[4],$inames[5], 0 + $_POST["type"], $namet.$dname))) . ", '" . get_date_time() . "', '" . get_date_time() . "', ".sqlesc($kp).", '$reliz', ".$stats.", ".$statu.");");
