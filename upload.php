...
tr("Ожидаемый релиз", "<label><input type=\"checkbox\" ".(!empty($name_link)? "checked":"")." name=\"future\" value=\"yes\"><i>Включить / Выключить.</i> </label><br>Если включена эта опция - торрент-файл игнорируется!", 1);
